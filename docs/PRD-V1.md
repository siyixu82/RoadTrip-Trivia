...
>
> **What's already in MVP (pulled forward from this vision):** a library of
> pre-authored place-based quizzes, the core quiz-play loop with immediate feedback,
> a Saved library, and a played/completed history with scores.
>
> **What V1 adds back on top of MVP:** AI/two-path quiz generation, location
> awareness, Mode Select + Read-Aloud / Driver Mode, the Explore marketplace,
> gamified results, the Settings/Profile screen, and resume-in-progress.
